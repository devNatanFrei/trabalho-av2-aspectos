...
def decisao():
    ...
    # Se o próximo token imediatamente após THEN for ELSE,
    ...
    comando()  # Processa o comando da cláusula THEN

    # A verificação original para ELSE ainda é necessária para casos como "IF A THEN PRINT A END" (falta ELSE)
    if not match("ELSE"):
        error("Esperado ELSE após o comando da cláusula THEN") # Mensagem pode ser mais específica
